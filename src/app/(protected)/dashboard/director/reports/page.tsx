...
export default async function DirectorReportsPage({ searchParams }: PageProps) {
  ...
  return (
    <section className="space-y-6">
      <Header title="Informes trimestrales" description="Supervision del cierre de materias y notas oficiales." />
